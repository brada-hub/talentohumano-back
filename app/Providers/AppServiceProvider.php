...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->register(\Src\Geo\Infrastructure\Providers\GeoServiceProvider::class);
        $this->app->register(\Src\Reportes\Infrastructure\Providers\ReportesServiceProvider::class);
    }
